...
public class TreeLookupPresentBenchmark {
    ...
    public List<Boolean> lookupWithBTree1000(BenchmarkState state) {
      ...
      IntStream.range(50000, 90000).forEach((i) -> result.contains(state.btree1000.add(i)));
    ...
    public List<Boolean> lookupWithBTBTree100(BenchmarkState state) {
      ...
      IntStream.range(50000, 90000).forEach((i) -> result.contains(state.btree100.add(i)));
    ...
    public List<Boolean> lookupWithBTree10(BenchmarkState state) {
      ...
      IntStream.range(50000, 90000).forEach((i) -> result.contains(state.btree10.add(i)));
    ...
    public List<Boolean> lookupWithJavaTree(BenchmarkState state) {
      ...
      IntStream.range(50000, 90000).forEach((i) -> result.contains(state.javaTree.add(i)));
